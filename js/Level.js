 ...
 * includes methods:
 * 
 * setBoundsData() - extracts the zone data from the boundary map image
 * draw() - draws the background image and the level image
 * getZoneInfo() - returns zone information about a point in the boundary map
 */
...
// extracts the zone data from the boundary map image
...
// draws the background image and the level image
...
// returns zone information about a point in the boundary map
